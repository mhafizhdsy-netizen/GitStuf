...
import { Star, GitFork, Eye, Scale, Download, Copy, ChevronDown, Check, Code } from 'lucide-react';
  ...
  return (
    <header className="flex flex-col md:flex-row md:items-start justify-between gap-4">
      ...
      <div className="relative flex-shrink-0" ref={dropdownRef}>
        ...
        {isCodeOpen && (
          <div className="absolute right-0 top-full mt-2 w-72 bg-white dark:bg-base-900 border border-base-200 dark:border-base-700 rounded-xl shadow-xl z-20 overflow-hidden animate-fade-in">
            <div className="p-3">
