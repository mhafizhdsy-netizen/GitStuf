      ...
      <footer className="bg-base-50 dark:bg-base-950 border-t border-base-200 dark:border-base-800 py-6 mt-auto">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 dark:text-base-400">
          <div className="flex items-center mb-3 md:mb-0">
             <GitStufIcon className="w-4 h-4 mr-2 opacity-50" />
             <span className="font-medium">&copy; {new Date().getFullYear()} GitStuf</span>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-6 lg:col-span-4 flex flex-col items-start">
            <Link to="/" className="flex items-center space-x-2 mb-6 group">
              ...
              <span className="font-bold text-2xl text-gray-800 dark:text-gray-100 tracking-tight">GitStuf</span>
            </Link>
          ...
          <div className="col-span-2 md:col-span-2 lg:col-span-3">
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-3 bg-base-100 dark:bg-base-900 rounded-full hover:bg-blue-400 hover:text-white transition-all text-gray-600 dark:text-base-400 border border-transparent hover:border-blue-400/20 group shadow-sm" 
                aria-label="Twitter"
              >
