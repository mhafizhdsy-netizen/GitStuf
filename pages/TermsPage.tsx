        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose dark:prose-invert max-w-none prose-h2:font-bold prose-h2:text-2xl prose-h2:mb-4 prose-h2:mt-10 prose-h2:border-b prose-h2:border-base-200 dark:prose-h2:border-base-800 prose-h2:pb-3 prose-h3:font-semibold prose-h3:text-lg prose-h3:mt-8 prose-h3:mb-3 prose-a:text-primary hover:prose-a:underline prose-li:my-1.5 text-gray-700 dark:text-base-300">
              ...
              <p className="lead text-lg">
                  Welcome to GitStuf! This document outlines the rules for using our service and explains how we handle your data. By using our application, you agree to these terms.
              </p>

              <h2>1. Acceptance of Terms</h2>
              <p>
                  By accessing and using GitStuf ("the Service"), you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to abide by these, please do not use this Service.
              </p>
              ...
              <ul>
                  <li>When you use AI features, the relevant data (e.g., repository metadata, selected code snippets) is sent directly from your browser to the Google Gemini API for processing. This data is not logged or stored by GitStuf.</li>
              </ul>
              <h3>3.3. Analytics</h3>
              ...
              <p>
                  ...
                  You should not rely on the AI-generated content as a sole source of truth and should always verify critical information. GitStuf is not responsible for any inaccuracies or damages resulting from the use of AI-generated content.
              </p>

              <h2>5. Disclaimer of Warranties</h2>
              <p>
                  The Service is provided on an 'as is' and 'as available' basis. GitStuf makes no warranties, expressed or implied, 
