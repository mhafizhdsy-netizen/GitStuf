            ...
            <div className="max-w-3xl mx-auto">
              <div className="relative mb-16 animate-fade-in">
                ...
                <p className="text-xl text-gray-600 dark:text-base-300">
                  Master GitStuf's features to explore, analyze, and understand GitHub repositories faster than ever before.
                </p>
              </div>
              ...
              <div className="space-y-16">
                <section id="intro">
                  {renderProse(<>
                    ...
                    <p>Welcome to GitStuf! This is a specialized GitHub browser designed for <strong>readers</strong> of code. While GitHub's interface is built for collaboration (issues, PRs, management), GitStuf is optimized for understanding existing codebases quickly.</p>
                ...
                <section id="repo-features">
                   {renderProse(<>
                    ...
                    <p>The repository detail page is the heart of GitStuf, divided into logical sections to help you navigate large projects easily.</p>
                ...
                <section id="ai-features">
                   {renderProse(<>
                    ...
                    <p>GitStuf integrates <strong>Google Gemini AI</strong> to turn raw code into insights. This requires a self-configured API Key in settings.</p>
                ...
                <section id="faq">
                   {renderProse(<>
                    ...
                    <p>Yes. GitStuf operates entirely on the client-side. Your tokens and settings never leave your browser.</p>
                   </>)}
                </section>
              </div>
            </div>
